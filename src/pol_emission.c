...
double A_I_low(double theta_e, double n_e, double nu, double B, double theta_B) {
...
double A_S_Q(double theta_e, double n_e, double nu, double B, double theta_B) {
    return pow((pow(A_low, -x) + pow(A_high, -x)), -1. / x)*A_S_factor_Q;
}
double A_S_V(double theta_e, double n_e, double nu, double B, double theta_B) {
