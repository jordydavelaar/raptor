...
def plot_data_tau(image,data_id,ind,fig,ax,halfrange=40,mas=1,label="Stokes",cmap="RdBu"):
    ...
    for i in range(0,len(image[data_id[ind]])):
        ...
        figure=ax.pcolormesh(alpha,beta,np.log10(array),vmin=-2,vmax=2,cmap=cmap,shading='auto')
