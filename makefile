...
SRC2=img_renderer.c GRmath.c integrator.c metric.c plasma.c radiative_transfer.c tetrad.c raptor_harm3d_model.c utilities.c
OBJ2=img_renderer.o GRmath.o integrator.o metric.o plasma.o radiative_transfer.o tetrad.o raptor_harm3d_model.o utilities.o
