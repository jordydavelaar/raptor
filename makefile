...
SRC2=img_renderer.c GRmath.c integrator.c metric.c emission.c tetrad.c raptor_harm3d_model.c utilities.c
OBJ2=img_renderer.o GRmath.o integrator.o metric.o emission.o tetrad.o raptor_harm3d_model.o utilities.o
