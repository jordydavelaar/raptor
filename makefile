...
SRC2=main.c core.c io.c GRmath.c integrator.c metric.c emission.c tetrad.c raptor_harm3d_model.c utilities.c
OBJ2=main.o core.o io.o GRmath.o integrator.o metric.o emission.o tetrad.o raptor_harm3d_model.o utilities.o
